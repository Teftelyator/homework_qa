...
public class Constant {
    ...
    public static class Placeholders{
        ...
        public static final String PLACEHOLDER_EMAIL_FIELD = "E-mail для отправки чека";
        public static final String PLACEHOLDER_SCORE_INSTALMENT_NUMBER = "Номер счета на 44";
        public static final String PLACEHOLDER_SCORE_ARREARS_NUMBER = "Номер счета на 2073";
